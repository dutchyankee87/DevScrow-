...
export function ShareWidget({ config }: ShareWidgetProps) {
  const [dismissed, setDismissed] = useState(false)
  
  const shareUrl = `https://wa.me/?text=${encodeURIComponent(config.shareText)}`
  const buttonText = config.buttonText || "Share Now"
